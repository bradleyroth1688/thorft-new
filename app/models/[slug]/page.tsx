...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  if (!model) return {};
  return {
    title: `${model.name} Model Portfolio`,
    description: model.tagline + ". " + model.description[0].substring(0, 150) + "...",
  };
}
          ...
          <div className="container-max mx-auto">
            <div className="bg-navy-50 border border-navy-100 rounded-2xl p-8 md:p-10 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  Learn More at thorfunds.com
                </a>
                <Link href="/funds" className="btn-outline">
                  View All THOR Funds
                </Link>
              </div>
            </div>
