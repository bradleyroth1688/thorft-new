...
export const metadata: Metadata = {
  ...
  description:
    "Hypothetical performance factsheet for the THOR Dollar ALT model portfolio. S&P 500 sector-based equal-weight strategy with proprietary risk management.",
