...
import {
  ...
  riskStats,
  monthlyReturns,
} from "@/data/levered-index-performance";
import {
  asOfLabel,
  coverageLabel,
  inceptionLabel,
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-12 print:py-6 print:space-y-8">
        ...
        <section>
          ...
          <div className="text-gray-600 leading-relaxed space-y-3 max-w-4xl">
            <p>
              The THOR Levered Index model portfolio is THOR&apos;s flagship strategy, providing systematic exposure to S&P 500 sectors using an equal-weight approach with proprietary risk management. The portfolio trades sector-based ETFs representing the major sectors of the S&P 500.
            </p>
            <p>
        ...
        <section>
          ...
          <p className="text-xs text-gray-500 mb-3">
            THOR Levered Index (Net) monthly returns. Net of 0.49% management fee.
          </p>
          <div className="overflow-x-auto">
