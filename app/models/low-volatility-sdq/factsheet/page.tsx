...
import {
  ...
  riskStats,
  monthlyReturns,
} from "@/data/low-volatility-sdq-performance";
import {
  asOfLabel,
  coverageLabel,
  inceptionLabel,
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4">
            ...
            <div className="text-right text-sm text-gray-300 space-y-1 mt-2">
              <p className="text-white font-semibold">As of {asOfLabel(monthlyReturns)}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              ...
              <div className="text-sm font-semibold mt-1">SPDR S&P 500 ETF (SPY)</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-3">
              <div className="text-xs text-gray-400 uppercase tracking-wider">Inception</div>
              <div className="text-sm font-semibold mt-1">{inceptionLabel(monthlyReturns)}</div>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-3">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-12 print:py-6 print:space-y-8">
        ...
        <section>
          ...
          <div className="text-gray-600 leading-relaxed space-y-3 max-w-4xl">
            <p>
              The THOR Low Volatility SDQ model portfolio is THOR&apos;s flagship strategy, providing systematic exposure to S&P 500 sectors using an equal-weight approach with proprietary risk management. The portfolio trades sector-based ETFs representing the major sectors of the S&P 500.
            </p>
            <p>
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 mb-4">
            Hypothetical growth of a $10,000 investment from {coverageLabel(monthlyReturns)}. Net of 0.49% management fee.
          </p>
        ...
        <section>
          ...
          <p className="text-xs text-gray-500 mb-3">
            THOR Low Volatility SDQ (Net) monthly returns. Net of 0.49% management fee.
          </p>
          <div className="overflow-x-auto">
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 mb-4">
            Hypothetical growth of a $10,000 investment from {coverageLabel(monthlyReturns)}.
          </p>
        ...
        <section>
          ...
          <p className="text-xs text-gray-500 mb-3">
            Calculated from monthly returns, {monthRangeLabel(monthlyReturns)}. Sharpe ratio assumes a 2.00% risk-free rate.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
