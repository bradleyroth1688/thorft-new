...
export const metadata: Metadata = {
  ...
  description:
    "Hypothetical performance factsheet for the THOR Low Volatility SDQ model portfolio. S&P 500 sector-based equal-weight strategy with proprietary risk management.",
