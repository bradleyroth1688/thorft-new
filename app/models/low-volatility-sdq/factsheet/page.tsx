      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-12 print:py-6 print:space-y-8">
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 mb-4">
            Hypothetical growth of a $10,000 investment from January 2017 through April 30, 2026. Net of 0.49% management fee.
          </p>
        ...
        <section>
          ...
          <p className="text-sm text-gray-500 mb-4">
            Hypothetical growth of a $10,000 investment from January 2017 through April 30, 2026.
          </p>
        ...
        <section>
          ...
          <p className="text-xs text-gray-500 mb-3">
            Calculated from monthly returns, January 2017 – April 2026. Sharpe ratio assumes a 2.00% risk-free rate.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full border-collapse">
              <thead>
