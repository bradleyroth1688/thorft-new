...
export default function HomePage() {
  return (
    <>
      ...
      {/* Hero Section */}
      <article>
        <section className="gradient-navy text-white py-24 md:py-36 relative overflow-hidden" aria-label="Hero">
        ...
        {/* What We Do */}
        <section className="section-padding bg-white" aria-label="What We Do">
          <div className="container-max mx-auto">
        ...
        <section className="section-padding bg-gray-50" aria-label="Model Portfolios">
          <div className="container-max mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-navy-800 mb-4">
                Model Portfolios
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {models.map((model) => (
                <Link key={model.name} href={model.href} className="card group hover:border-gold-400/50">
                  <div className="flex items-start justify-between mb-4">
                    <h3 className="text-xl font-bold text-navy-800 group-hover:text-gold-600 transition-colors">{model.name}</h3>
        ...
        {/* Differentiators */}
        <section className="section-padding bg-white" aria-label="Why THOR Is Different">
          <div className="container-max mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-navy-800 mb-6">Why THOR Is Different</h2>
        ...
        {/* Social Proof */}
        <section className="section-padding gradient-navy text-white" aria-label="Featured In">
        ...
        {/* Book & Podcast */}
        <section className="section-padding bg-white" aria-label="Book and Podcast">
          <div className="container-max mx-auto">
        ...
        {/* CTA */}
        <section className="section-padding bg-gradient-to-br from-gold-400 to-gold-500" aria-label="Call to Action">
          <div className="container-max mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-navy-800 mb-4">Ready to Explore Systematic Investing?</h2>
