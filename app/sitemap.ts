...
const blogPosts = blogPostsData as unknown as DatedEntry[];
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const modelPages: MetadataRoute.Sitemap = models.flatMap((m) => [
    { url: `${baseUrl}/models/${m.slug}/`, lastModified: today, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${baseUrl}/models/${m.slug}/factsheet/`, lastModified: today, changeFrequency: "monthly" as const, priority: 0.7 },
  ]);
