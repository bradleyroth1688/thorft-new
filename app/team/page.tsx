            ...
            <div className="lg:col-span-1">
              <div className="bg-navy-800 rounded-2xl p-8 text-white text-center sticky top-28">
                ...
                <div className="flex justify-center gap-4">
                  <a href="https://www.linkedin.com/in/brad-roth-thor/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-gold-400/20 transition-colors">
