        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-5">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/brad-roth-8a4a8619a/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold-400 transition-colors">
